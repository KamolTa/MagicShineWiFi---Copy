...
<tr>
 ...
 <img src="images/icon_3.jpg" > <font color="purple" size="-1" style="font-weight:bold">Silver Package</font> <s class="text-red">25</s> ลดเหลือ 20 บาท / 1 ชั่วโมง (ภายใน 1 เดือน, ใช้ได้ 1 เครื่อง)	<br>
 <img src="images/icon_3.jpg" > <font color="#33CCFF" size="-1" style="font-weight:bold">Ruby Package</font> <s class="text-red">100</s> ลดเหลือ 50 บาท / 1 วัน (ไม่จำกัดชั่วโมง, ใช้ได้ 1 เครื่อง) <br>
...
<img src="images/icon_3.jpg" > <font color="#006400" size="-1" style="font-weight:bold">Niobium Package</font> แพ็กเกจน้องใหม!!!่ 700 บาท / 6 เดือน (ไม่จำกัดชั่วโมง, ใช้ได้ 1 เครื่อง) <br>
